...
# Author: LAB2_COM1_G6_BARRETO_FERREIRA
...
class COM1_LAB1_PARTE2_G6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "COM1_LAB1_PARTE2_G6")
        ...
        self._A_range = Range(0, 1, 0.0001, 500e-3, 200)
...
def main(top_block_cls=COM1_LAB1_PARTE2_G6, options=None):
