...
class LAB1_PARTE2_PUNTO4_COMU1_G6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "LAB1_PARTE2_PUNTO4_COMU1_G6")
...
def main(top_block_cls=LAB1_PARTE2_PUNTO4_COMU1_G6, options=None):
