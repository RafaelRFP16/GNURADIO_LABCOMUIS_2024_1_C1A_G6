...
# Title: lab1_punto6
# Author: rafael_ferreira_camilo_barreto_C1A_G6
...
class LAB1_PARTE2_PUNTO6_COMU1_G6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "LAB1_PARTE2_PUNTO6_COMU1_G6")
        ...
        self._f_central_range = Range(100, 21000, 10, 1500, 200)
        self._f_central_win = RangeWidget(self._f_central_range, self.set_f_central, "frecuencia central", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._f_central_win)
        ...
        # Connections
        ##################################################
        self.connect((self.band_pass_filter_1, 0), (self.qtgui_freq_sink_x_0, 1))
        self.connect((self.band_pass_filter_1, 0), (self.rational_resampler_xxx_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_1.set_taps(firdes.band_pass(1, self.samp_rate, self.f_central-self.BW/2, self.f_central+self.BW/2, 100, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=LAB1_PARTE2_PUNTO6_COMU1_G6, options=None):
